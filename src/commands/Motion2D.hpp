...
namespace base
{
    ...
    struct Motion2D
    {
        ...
        Motion2D(double _translation, double _rotation):translation(_translation), rotation(_rotation), heading(base::Angle::fromRad(0)){};
        Motion2D(double _translation, double _rotation, base::Angle _heading):translation(_translation), rotation(_rotation), heading(_heading){};
    };
